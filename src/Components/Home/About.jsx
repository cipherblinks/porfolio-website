...
function About() {
    ...
    return (
        <>
            <section className="flex items-start justify-center overflow-visible gap-[10px] text-white w-full md:max-w-[1500px] py-[40px] px-[16px] md:py-[120px] md:px-[64px] relative md:mt-32">
                {/* background animation */}
                <div className="top-0 bottom-0 left-0 max-w-[1316px] pl-8 absolute w-full">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center w-full overflow-visible gap-20 md:gap-[160px] relative service-section">
                    {/* about image */}
                    <div className="flex items-center flex-nowrap w-full md:w-min h-min rounded-[24px] justify-center overflow-hidden p-px relative bg-[linear-gradient(214deg,rgb(43,43,46)_0%,rgb(43,43,46)_9%,rgb(168,168,181)_20%,rgb(73,73,77)_40%,rgb(43,43,46)_62.1622%,rgb(43,43,46)_100%)]">
                        <div className="flex-1 md:flex-none w-full h-[400px] md:h-[700px] md:w-[510px] relative rounded-[23px]">
                    ...
                    <div className="flex flex-col items-start flex-1 gap-10 flex-nowrap overflow-visible justify-start relative">
                        <div className="flex flex-col gap-4">
                            <div className="flex gap-3 items-center relative">
                                <img src="/src/assets/images/logo.svg" alt="" className="size-8 mb-4 absolute bottom-2 -left-6 hidden md:block" />
                                <p className="text-xs md:text-sm text-[rgba(255,255,255,0.6)] font-bold uppercase leading-[1.3em] tracking-widest">CIPHER BLINKS</p>
                            </div>
                            <h5 className="text-3xl md:text-8xl font-bold leading-8 md:leading-[106px]">About</h5>
                        </div>


                        <div className="flex flex-col gap-5 w-full">
                            <p className="text-[rgba(255,255,255,.7)] text-sm md:text-base font-light leading-[1.4em] tracking-tight">
                            ...
                            <p className="text-[rgba(255,255,255,.7)] text-sm md:text-base font-semibold leading-[1.4em] tracking-tight">
