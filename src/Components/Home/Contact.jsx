    ...
    return (
        <>
            ...
            mx-auto py-[120px] px-[64px] relative">
                <div className="flex items-centercenter justify-center flex-col gap-20 w-full">
                    ...
                    <div className="flex items-start gap-[64px] overflow-x-hidden relative justify-center w-full">
                        <div className="flex flex-col justify-start flex-1 space-y-4 relative ">
                            <p className="text-[rgba(255,255,255,.7)] font-semibold text-[18px]">
                            ...
                            <p className="text-[rgba(255,255,255,.7)] text-[18px]">Let's connect!</p>
                        </div>

                        <form action="" className="flex items-start flex-col flex-nowrap overflow-hidden w-[60%] relative justify-start gap-[16px]">
                            <label className="flex flex-col items-start gap-[4px] justify-start relative w-full">
                                <div>
                                    <p className="text-xs font-semibold text-[rgba(255,255,255,.7)] leading-[1.6em]">Name</p>
                                </div>
                                <div className="flex items-center bg-[rgba(187,187,187,0.15)] border border-[#bbbbbb26] rounded-[10px] h-[44px] relative w-full">
                                    <input type="text" required placeholder="Cipher Blinks" className="bg-transparent text-sm font-medium text-[rgb(153,153,153)]
                                     border-none p-[8px] h-[44px] relative w-full text-ellipsis size-full focus:outline-0 focus:outline-[rgb(144,144,144)] placeholder:font-medium" />
                                </div>
                            </label>

                            <label className="flex flex-col items-start gap-[4px] justify-start relative w-full">
                                <div>
                                    <p className="text-xs font-semibold text-[rgba(255,255,255,.7)] leading-[1.6em]">Email</p>
                                </div>
                                <div className="flex items-center bg-[rgba(187,187,187,0.15)] border border-[#bbbbbb26] rounded-[10px] h-[44px] relative w-full">
                            ...
                            <label className="flex flex-col items-start gap-[4px] justify-start relative w-full">
                                <div>
                                    <p className="text-xs font-semibold text-[rgba(255,255,255,.7)] leading-[1.6em]">Message</p>
                                </div>
                                <div className="flex items-center bg-[rgba(187,187,187,0.15)] border border-[#bbbbbb26] rounded-[10px] relative w-full p-[12px] min-h-[120px]">
                                    ...
                                    placeholder:font-medium bg-transparent text-sm font-medium text-[rgb(153,153,153)] border-none p-[8px] min-h-[120px] h-full"></textarea>
                                </div>
                            </label>
                            <div className="flex items-center justify-center w-full">
                                <button
                                    className="px-6 py-2 text-base w-full bg-black font-medium rounded-full border border-custom cursor-pointer transition delay-200 duration-500 ease-in-out hover:bg-button-dark">
                                    Submit
                                </button>
                            </div>
                        </form>
